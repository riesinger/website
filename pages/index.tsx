...
export default function Home() {
  return (
    <Layout header footer>
      <Hero>
        <h1>
          <span style={{ color: "var(--riesinger-colors-typeface-secondary)" }}>
            Hello{" "}
            <motion.div
              css={css`
          ...
          <AboutMeGrid>
            <div>
              <p>
                ...
                software-rendered graphics are too slow and therefore I learned
                some{" "}
                <a href="https://github.com/riesinger/glow">OpenGL and C++</a>.
                Unfortunately, that project never was finished (you know how it
                is 😉).
              </p>
              <p>
            ...
            <div>
              <p>
                ...
                friends which unfortunately ultimately failed. However,
                I&apos;ve learned much from the project, including backend
                programming in Go, database management and containerization with
                Docker.
              </p>
              <p>
                After school, I enrolled in a cooperative study program to get
                my bachelor&apos;s in computer science. While studying at DHBW
                Karlsruhe, I worked in multiple departments within SAP, both as
                a frontend developer as well as a backend developer. Since I
                finished my bachelor&apos;s degree in 2020, I&apos;m now a
                full-time employee at SAP, mostly working on backend services in
                Go and Kotlin.
              </p>
            </div>
          </AboutMeGrid>
