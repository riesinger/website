...
Previously, NoNonsense.cooking was a Next.JS site. Since it's inception, I've become more and more busy though, so in 2026 I've switched it to be a static site generate with [Hugo](https://gohugo.io) to reduce the maintainance burden.
