...
![A good example for motion in an app. Source: https://material.uplabs.com/posts/music-player-transition](guide.gif)
...
![The playlist is now animated](second.gif)
