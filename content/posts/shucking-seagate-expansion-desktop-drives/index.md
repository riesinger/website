...
subtitle: "Save money by using external hard-drives in your next server build without having a bunch of USB adapters."
...
![As you'll later see, these are the same exact drives. However, the internal one is about 20€ more](price_comparison.png)
...
![Seagate expansion desk with the cover opened](case.jpg)
...
![Remove this screw](screw_marked.jpg)
...
![Lift the tape on one corner and then pull it off by hand](tape.jpg)

That's it! You can now remove the SATA-to-USB daughter board by gently pulling it out and plug in
